...
![A city at night with a couple of bright pink and purple billboards](images/Zwart.png "A dark Los Angeles with some neon billboards")
...
![A video frame with a bright white shadow around it](images/White%20box-shadow.png "First test for an alarm idea")
...
![A screenshot from a scene from the movie can be seen with red and blue gradient colors around it](images/sirens.png "The two colors rotate around the video frame")
...
![An example of a subtitle for voice 1 can be seen](images/voice%201%20text.png "This is how voice 1 (the interrogator) looks like")
...
![An example of a subtitle for voice 2 can be seen](images/voice%202%20text.png "This is what the text for voice 2 looks like")
...
* Second fragment of the video, time 1:38. When his boss speaks the word *love*, it sounds lovely but full of sarcasm at the same time. So I made the word *love* with a different font style of the Brenner family: `Brenner Script`. And to make it easier to read: `font-style: bold;`.
  ...
  ![An image of the word love can be seen on a black backgorund](images/the%20word%20love.png "This is how the word 'love' looks like")
...
![A screenshot of the video at 2 minutes where an animation is being played](images/scanning%20light.png "The 'scanner' animation can be seen here in action ")
